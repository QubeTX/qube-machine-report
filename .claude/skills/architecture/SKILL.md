...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](./CONNECTORS.md). (Note: this is a general placeholder doc — TR-300 is a standalone CLI with no SaaS integrations, so most categories don't apply.)
