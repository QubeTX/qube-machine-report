...
- [ ] **TR-300 v4.3.0 battery, latency, thermals** - unreleased PR #14 plus release-chain hardening PR #15; operator-authorized merge/publication/deployment remains blocked by exact-SHA hosted gates, Mac preinstall-only scoped-home policy and receipt-aware uninstall proof on Intel/ARM, Apple/crates credential cutovers, and public-byte acceptance #v43
