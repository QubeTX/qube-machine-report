TT;DR: Audit the freshly published v4.1.0 bytes and close every release ledger only after all 30 assets, trust checks, installer channels, and recovery paths are proven.
...
- [ ] crates.io and all 30 release assets match the intended v4.1.0 release
...
Blocked on #rsh. Resume only after all publication workflows finish.
