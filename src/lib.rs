...
//!
//! ```no_run
//! use tr_300::{collectors::SystemInfo, config::Config, report};
//!
...
/// Generate a system report with default configuration
...
/// Generate a system report with custom configuration
